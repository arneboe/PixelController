...
public class LedSimulatorOutputWindow {
    ...
    public void calculateWindowsSize(Layout layout) {
        ...
        do {
            ...
            if (sanityCheck++ > 200) {
                LOG.log(Level.SEVERE, "Infitie loop detected, fail here, current point: "
                        + windowSize);
                throw new IllegalStateException(
                        "Verify your configure resolution, something is fishy!");
            }
        ...
        ledSizeY = ledSize;// *matrixData.getDeviceYSize() < MINIMAL_SIZE ?
                           // MINIMAL_SIZE : ledSize;
