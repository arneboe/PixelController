 ...
 * @author mvogt
 */
public class Stripes extends Generator {
    ...
    /** The Constant LOG. */
    private static final Logger LOG = Logger.getLogger(Stripes.class.getName());
     ...
     *            the filename
     */
    public Stripes(MatrixData matrix, FileUtils fu, IResize resize) {
