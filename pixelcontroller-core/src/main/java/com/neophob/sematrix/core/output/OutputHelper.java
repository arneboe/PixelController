...
/**
 * Output Helper Class Contains some common helper methods used by the output
 * devices
 * 
 * @author michu
 */
public class OutputHelper {
    ...
    /**
     * this function feed the framebufferdata (32 pixels a 2bytes (aka 16bit) to
     * the send array. each second scanline gets inverteds
     * 
     * @param cmdfull
     *            the cmdfull
     * @param frameData
     ...
     */
    public static byte[] convertBufferTo15bit(int[] data, ColorFormat colorFormat)
            throws IllegalArgumentException {
     ...
     */
    public static byte[] convertBufferTo15bit(int[] data, ColorFormat colorFormat,
            RGBAdjust correction) throws IllegalArgumentException {
        int targetBuffersize = data.length;
     ...
     *             the illegal argument exception
     */
    public static byte[] convertBufferTo24bit(int[] data, ColorFormat colorFormat)
            throws IllegalArgumentException {
        int targetBuffersize = data.length;
     ...
     * @param b
     */
    private static void splitUpBuffers(int targetBuffersize, int[] data, ColorFormat colorFormat,
            int[] r, int[] g, int[] b) {
        int ofs = 0;
        int tmp;
